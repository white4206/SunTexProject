    ...
    <scroll-view enable-back-to-top scroll-y class="scroll-view" @scrolltolower="onScrolltolower">
        ...
        <template v-if="false">
            ...
            <view class="cart-list" v-if="true">
                ...
                <uni-swipe-action>
                    ...
                    <uni-swipe-action-item v-for="item in cartList" :key="item.skuId" class="cart-swipe">
                        ...
                        <view class="goods">
                            <!-- 选中状态 -->
                            <view @tap="onChangeSelected(item)" class="checkbox selected">
                                <image src="../../static/images/selected.png" mode="scaleToFill" v-if="item.selected" />
                                <image src="../../static/images/select.png" mode="scaleToFill" v-else />
                            </view>
                            <navigator :url="`/pages/goodsDetail/goodsDetail?id=${item.id}`" hover-class="none"
                                class="navigator">
                                <image mode="aspectFill" class="picture" :src="item.imgURL"></image>
                                <view class="meta">
            ...
            <view v-if="showCartList" class="toolbar"
                ...
                <view @tap="onChangeSelectedAll" class="all isSelectedAll">
                    <image src="../../static/images/selected.png" mode="scaleToFill" v-if="isSelectedAll" />
                    <image src="../../static/images/select.png" mode="scaleToFill" v-else />
                    <text>全选</text>
                </view>
